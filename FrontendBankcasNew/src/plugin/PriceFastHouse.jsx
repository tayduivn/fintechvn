...
class PriceFastHouse extends React.Component {
  ...
  componentDidMount(){
    let { profile, feeHouse, feeNameExtendHouse, yearHouse,
      feeHouseActions, feeNameExtendHouseActions, yearHouseActions } = this.props;
  ...
  render() {
    let dataRequest = null, disabled = false;
    let { t, feeNameExtendHouse, feeHouse, yearHouse } = this.props;
      ...
      <React.Fragment>
...

        {
          !!feeNameExtendHouse && !!feeNameExtendHouse.ordered && feeNameExtendHouse.ordered.map(e => {
            ...
            // let checked = !!feeExtend && feeExtend[e];
